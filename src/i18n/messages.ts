...
const zhCN = {
  ...
  collection: {
    ...
    pavilionAir: '天空展区',
    pavilionWater: '海洋展区',
    habitatCount: (count: number) => `${count} 位`,
    ...
    uxModeCards: '绘本大卡',
    uxModeClassic: '经典平铺',
    storyCardLandTitle: '陆地之森',
    storyCardLandSubtitle: '恐龙与史前巨兽',
    storyCardAirTitle: '辽阔苍穹',
    storyCardAirSubtitle: '翼龙与天空飞客',
    storyCardWaterTitle: '蔚蓝深海',
    storyCardWaterSubtitle: '海怪与远古潜游者',
    storyCardAll: '全馆朋友',
    elevatorStrataSky: '苍穹展区',
    elevatorStrataLand: '原始陆表',
    elevatorStrataWater: '远古深渊',
    elevatorAirCount: (count: number) => `${count} 位天空飞客`,
    elevatorLandCount: (count: number) => `${count} 位陆行巨兽`,
    elevatorWaterCount: (count: number) => `${count} 位深海潜游`,
    elevatorHorizonSkyLand: '地平线界线 · DATUM 0m',
    elevatorHorizonLandSea: '大陆架下潜界线 · SUB-SURFACE',
    elevatorTotemAir: '苍穹',
    elevatorTotemLand: '陆地',
    elevatorTotemWater: '海洋',
    elevatorBeaconAir: '当前生态信标：苍穹飞鸟',
    elevatorBeaconLand: '当前生态信标：原始陆兽',
    elevatorBeaconWater: '当前生态信标：深海游鱼',
  },
  about: {
    eyebrow: 'Leon做了个',
    title: '关于这座博物馆',
...
const en = {
  ...
  collection: {
    ...
    habitatAir: 'Sky',
    habitatWater: 'Sea',
    pavilionLand: 'Land exhibits',
    pavilionAir: 'Sky exhibits',
    pavilionWater: 'Sea exhibits',
    habitatCount: (count: number) => `${count}`,
    filterByHabitat: (habitat: string) => `Filter by ${habitat}`,
    uxModeLabel: 'UX mode',
    uxModeTabs: 'Pills',
    uxModeGrouped: 'Sections',
    uxModeCards: 'Story cards',
    uxModeClassic: 'Flat',
    storyCardLandTitle: 'Ancient Forest',
    storyCardLandSubtitle: 'Dinosaurs & giants',
    storyCardAirTitle: 'Endless Sky',
    storyCardAirSubtitle: 'Pterosaurs & flyers',
    storyCardWaterTitle: 'Deep Ocean',
    storyCardWaterSubtitle: 'Marine swimmers',
    storyCardAll: 'All friends',
    elevatorStrataSky: 'Sky & Canopy',
    elevatorStrataLand: 'Primeval Land',
    elevatorStrataWater: 'Ancient Abyss',
    elevatorAirCount: (count: number) => `${count} sky flyers`,
    elevatorLandCount: (count: number) => `${count} land giants`,
    elevatorWaterCount: (count: number) => `${count} sea swimmers`,
    elevatorHorizonSkyLand: 'HORIZON DATUM · 0m',
    elevatorHorizonLandSea: 'CONTINENTAL SHELF · SUB-SURFACE',
    elevatorTotemAir: 'Sky',
    elevatorTotemLand: 'Land',
    elevatorTotemWater: 'Sea',
    elevatorBeaconAir: 'Current habitat beacon: Sky Bird',
    elevatorBeaconLand: 'Current habitat beacon: Land Giant',
    elevatorBeaconWater: 'Current habitat beacon: Sea Swimmer',
  },
  about: {
