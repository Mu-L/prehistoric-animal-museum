...
export const CAPTURE_ANCHORS: readonly CaptureAnchor[] = [
  ...
  { id: 'm1-beach', world: WORLD, position: {x:281,y:42,z:600}, heading:-Math.PI/2,view:'near',pitch:-.45,presentationSeconds:0,preset:'afternoon' },
  { id: 'm1-high-riverbank', world: WORLD, position: {x:-10,y:52,z:-2400}, heading:.4,view:'near',pitch:-.45,presentationSeconds:0,preset:'afternoon' },
  { id: 'm1-dry-slope', world: WORLD, position: {x:400,y:135,z:-900}, heading:.4,view:'near',pitch:-.45,presentationSeconds:0,preset:'afternoon' },
  { id: 'm1-woodland', world: WORLD, position: {x:700,y:400,z:-900}, heading:.4,view:'near',pitch:-.45,presentationSeconds:0,preset:'afternoon' },
  { id: 'm1-rock', world: WORLD, position: {x:300,y:160,z:-2200}, heading:.4,view:'wide',pitch:-.35,presentationSeconds:0,preset:'afternoon' },
  { id: 'm1-groundcover', world: WORLD, position: {x:1200,y:385,z:-700}, heading:.4,view:'near',pitch:-.45,presentationSeconds:0,preset:'afternoon' },
]
